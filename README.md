...
| Within-rank **diversity** ordering (2nd selection stage) | [`src/selection.py`](src/selection.py) | ⚠️ **substitute** — farthest-point in design space, *not* the paper's persistent-homology + Wasserstein-distance sort |
